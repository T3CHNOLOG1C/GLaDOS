...
class Colors:
    ...
    async def change(self, ctx, color, lang, cur_color, user):
        if not cur_color:
            ...
            await ctx.send("{} {} {} added.".format(user.mention, lang, color.name.lower()), delete_after=5)
            ...
            await ctx.send("{} {} {} removed.".format(user.mention, lang, color.name.lower()), delete_after=5)
